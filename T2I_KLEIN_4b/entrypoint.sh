...
echo "=========================================="
echo "Flux 2 Klein 4B Text2Image - Container startup - $(date)"
echo "=========================================="
...
check_model "$NETVOLUME/models/diffusion_models/flux-2-klein-4b.safetensors" "Flux 2 Klein 4B Distilled"
check_model "$NETVOLUME/models/text_encoders/qwen_3_4b.safetensors" "Qwen 3 4B CLIP"
